/* main_point_cloud.cpp
 *
 * This is our modification from: gvdb-voxels/source/gPointCloud/main_point_cloud.cpp
 */
...
void Sample::load_points ( std::string pntpath, std::string pntfile, int frame )
{
    ...
    // Set points for GVDB
    DataPtr dataPtr1, dataPtr2;
    gvdb.SetPoints( m_pnts, dataPtr1, dataPtr2);
...
{
    // Clear
    DataPtr dataPtr1, dataPtr2, dataPtr3;
    gvdb.SetPoints(dataPtr1, dataPtr2, dataPtr3);
    gvdb.CleanAux();
}
